...
def convert(costpath, file_name_1, file_name_2, name_1, name_2):
    ...
    #
    #     else:
    #         print('Something went wrong while working with costpath raster between '
    #               + loc_one_name + ' and ' + loc_two_name + '.')
    #         print('Script will continue with next iteration.  See error message for more details.')
    #         print(error)
    #         print('\n')
...
# Sets environmenatal parameters. Default is set to overwrite previous files of the same name.  Change to False to
...
working_directory = r'C:\Users\NAME\Desktop\FOLDER' # example of working directory, change to preferred location
...
fc_one = r'C:\PATH_TO_FILE\My_Feature_Class'
...
#  fc_one and fc_two.
digital_elevation_model = r'C:\PATH_TO_FILE\My_DEM'
...
fc_one_loc_filename = 'Short_Name'  # Change this to name of field in your feature class
fc_two_loc_filename = 'Short_Name'  # Change this to name of field in your feature class
...
fc_one_loc_name = 'Location_Name'  # Change this to name of field in your feature class.
fc_two_loc_name = 'Location_Name'  # Change this to name of field in your feature class
...
# are negligable, and there is little utility in iterating in both directions. If you are not calculating in both
...
cost_table = r'C:\PATH_TO_FILE\Cost_Table.txt'
